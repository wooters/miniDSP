/**
 * @file minidsp_gcc.c
 * @brief GCC-PHAT delay estimation: cross-correlation, delay search,
 *        and multi-signal delay estimation.
 ...
 *
 * IMPORTANT: This function does NOT reset _N.  It is called from
 * _xcorr_setup() where _N has already been set to the new value.
 * Resetting _N here would corrupt the value just set by the caller.
 */
